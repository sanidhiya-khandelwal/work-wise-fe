...
export const warningAlert = (message) => {
    enqueueSnackbar(message, { variant: 'warning', anchorOrigin: { horizontal: 'right', vertical: 'top' } })
}
...
export const defaultAlert = (message) => {
    enqueueSnackbar(message, { variant: 'default', anchorOrigin: { horizontal: 'right', vertical: 'top' } })
}